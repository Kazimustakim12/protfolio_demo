      ...
      >
        {testimonialsData.map((testimonial) => (
          <motion.div
            ...
            className={cn(
                'lg:col-span-1',
                (testimonial.id === 'testimonial-2' || testimonial.id === 'testimonial-3') && 'md:col-span-1',
                (testimonial.id === 'testimonial-1' || testimonial.id === 'testimonial-4' || testimonial.id === 'testimonial-5') && 'md:col-span-1',
          ...
          >
            <Card className={cn(
              ...
              testimonial.id === 'metric-2' && 'bg-primary text-primary-foreground',
            )}>
              {testimonial.type === 'testimonial' && (
                <CardContent className="p-0 flex flex-col h-full">
                  ...
                  <p className="text-muted-foreground flex-1 mb-6">&ldquo;{testimonial.content}&rdquo;</p>
              ...
              {testimonial.type === 'metric' && (
                <CardContent className="p-0 flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-8xl font-bold font-serif">{testimonial.metricValue}</p>
                    <p className="text-lg font-medium">{testimonial.metricLabel}</p>
                </CardContent>
              )}
            </Card>
          </motion.div>
