...
const ProjectCard = ({
  ...
  return (
    <div
      ref={container}
      className="h-auto md:h-[100vh] md:sticky top-0 flex items-center justify-center my-16 md:my-0"
    >
      <motion.div
  ...
  <motion.div className="w-full h-full">
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-8">
        <Badge
          variant="secondary"
          className="bg-secondary/80 text-secondary-foreground mb-4 backdrop-blur-sm"
        >
          {project.techStack[0]}
        </Badge>
        <h3 className="text-4xl md:section-title">{project.title}</h3>
