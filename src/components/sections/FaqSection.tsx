      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        <motion.div variants={itemVariants} className="md:sticky md:top-24">
          ...
          <p className="text-lg text-muted-foreground max-w-md">
            ...
            freelance designer. If you don’t see your question here, feel free
              ...
              <AccordionItem key={faq.id} value={faq.id}>
                <AccordionTrigger className="group py-6 text-left text-lg hover:no-underline">
                  <span className="flex items-start gap-4">
                    <span className="text-accent font-serif text-2xl md:text-4xl">
                      0{index + 1}
                    </span>
                    <span className="font-serif text-2xl md:text-4xl font-semibold transition-colors duration-300 group-data-[state=open]:text-accent uppercase">
                      {faq.question}
                    </span>
                  </span>
                </AccordionTrigger>
