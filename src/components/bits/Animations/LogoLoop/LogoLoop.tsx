    ...
    const rootClasses = useMemo(
      () =>
        cx(
          ...
          "dark:[--logoloop-fadeColorAuto:#1a1e2d]",
      ...
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          ...
          >
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>{(item as any).node}</TooltipTrigger>
        ...
        const inner = (item as any).href ? (
          <a
            className={cx(
              ...
              "hover:opacity-80",
              "focus-visible:outline focus-visible:outline-current focus-visible:outline-offset-2 h-full relative"
            )}
